...
In this Hands-on Lab we will walk through the steps to required to deploy an Active Directory domain in the cloud and provision new virtual machines into this domain.
...
If you find any issues with this hands-on lab that you can't fix, feel free to report them in the [issues](https://github.com/WindowsAzure-TrainingKit/HOL-DeployingSQLServerForSharePoint/issues) section of this repository.